...
<script>
    $(document).ready(function() {
        $(".delconfig").click(function() {
            ...
            if (confirm('Delete config, are you sure?')) {
                $.ajax({
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th colspan="6" class="text-center">
                                            <a href="add-config" class="btn btn-primary btn-large text-white">Add New Configuration</a>
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $con->email_type }}</td>
                                        <td class="text-center">{{ $con->email }}</td>
                                        <td class="text-center">
                                            <a href="edit-config-{{ $con->id }}" class="btn btn-warning">Edit</a>
                                            <a href="javascript:void(0)" cid="{{ $con->id }}" class="btn btn-danger text-white delconfig">Delete</a>
                                        </td>
                                    </tr>
                                    @php
                                    $sn++;
