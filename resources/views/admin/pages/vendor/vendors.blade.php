                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th colspan="6" class="text-center">
                                            <a href="add-vendor" class="btn btn-primary btn-large text-white">Add New Vendor</a>
                                        </th>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    $sn = 1;
                                    @endphp
                                    @foreach($VendorData as $banner)
                                    <tr>
                                        <td class="text-center">{{ $sn }}</td>
                                        <td class="text-center">{{ $banner->name }}</td>
                                        <td class="text-center">
                                            <img src="{{asset('/uploads/vendor/'.$banner->image)}}" width="60px" height="60px">
                                        </td>
                                        <td class="text-center">
                                            <a href="edit-vendor-{{ $banner->id }}" class="btn btn-warning">Edit</a>
