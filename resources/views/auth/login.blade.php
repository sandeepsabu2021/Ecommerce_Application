        ...
        <div class="jumbotron bg-dark">
            <div class="container">
                <h1 class="display-4 text-center">
                    <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="mr-3 align-text-bottom" height="64">
                    E-Comm App
                </h1>
                <p class="lead text-center">E-COMMERCE MANAGEMENT APPLICATION</p>
            </div>
        </div>
